...
**Difficulty:** Hard  
**Problem Link:** [LeetCode 3629](https://leetcode.com/problems/minimum-jumps-to-reach-end-via-prime-teleportation/) *(Note: Problem link may vary based on exact LeetCode ID)*
